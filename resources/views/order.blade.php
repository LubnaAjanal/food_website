...
<section id="book-a-table" class="book-a-table section">
    ...
    <div class="container section-title" data-aos="fade-up">
        <h2>Book an Order</h2>
        <p><span>Book Your</span> <span class="description-title">Food With Us<br></span></p>
    ...
    <div class="container">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-4 reservation-img" style="background-image: url(img/reservation.jpg);">
            </div>
